                                ...
                                <div className="ovInputWrapper">
                                    <FormItem>
                                        {getFieldDecorator('email', {
                                            rules: [{
                                                type: 'email', message: this.context.intl.formatMessage({id: 'forgot.email'}),
                                            }, {
                                                required: true, message: this.context.intl.formatMessage({id: 'forgot.email'}),
                                            }],
                                        })(
                                            <Input size="large" placeholder={this.context.intl.formatMessage({id: 'forgot.email'})} />
                                        )}
                                    </FormItem>
                                </div>
...
export default connect(null, null)(toJS(Form.create()(ForgotPassword)));
