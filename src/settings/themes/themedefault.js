...
theme.palette = {
    primary: [
        primary, // 0: Default
        LightenDarkenColor(primary, -4), // 1: Darken 4%
        LightenDarkenColor(primary, -5), // 2: Darken 5%
        "rgba(68, 130, 255, 0.2)", // 3: Fade 20%
        LightenDarkenColor(primary, 3), // 4: Lighten 3%
        "rgba(68, 130, 255, 0.75)", // 5: Fade 75%
        LightenDarkenColor(primary, 15), // 6: Lighten 15%
        LightenDarkenColor(primary, 12), // 7: Lighten 12%
        LightenDarkenColor(primary, -2), // 8: Darken 2%
        "#3369e7", // 9: Algolia color
        LightenDarkenColor(primary, 8), // 10: Lighten 8%
        LightenDarkenColor(primary, 8), // 11:
        LightenDarkenColor(primary, -10), // 12: darken 10%
        LightenDarkenColor(primary, 5) // 13: Lighten 5%
    ],
    secondary: [
        secondary, // 0: DarkBlue
        ...
        secondary // 10: Sidebar submenu select
    ],
    color: [
        "#FEAC01", // 0: Orange
        "#42299a", // 1: Purple
...
theme.fonts = {
    primary: "Sahel, Roboto, sans-serif",
